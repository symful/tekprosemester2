...
public class ProblemTwo {
    ...
    public static void main(String[] args) {
        ...
        List<Student> ans = students
            .stream() // [1] Membuka stream
            .sorted((s1, s2) -> {
                // [2] Melakukan pengurutan
                ...
                // Jika nama berbeda, bandingkan Nama
                    ...
                    return s1.getName().compareTo(s2.getName()); // [4]
                }
            })
...
// Class Student dengan attribute dan method yang diperlukan
class Student {
